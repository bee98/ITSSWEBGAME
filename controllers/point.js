...
exports.update = function(req, res, next) {
    ...
    Freak.findOne({ username: req.body.username }, function(e, freak) {
    	if(e) res.json({});
        if (freak.quickpoint < req.body.quickpoint && freak.normalpoint < req.body.normalpoint) Freak.updateOne({ username: req.body.username }, { quickpoint: req.body.quickpoint, normalpoint: req.body.normalpoint }, function(e) {
            db.off();
            res.json({});
        });
